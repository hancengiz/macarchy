...
If you struggle to build Macarchy locally, you can also refer to [builds in GitHub Actions](https://github.com/nikitabobko/AeroSpace/actions?query=branch%3Amain)
...
-   `install-from-sources.sh` - Build release build from sources and install it as `macarchy-dev` brew cask.
