...
let subcommandDescriptions = [
    ...
    ["  config", "Query Macarchy config options"],
    ...
    ["  eval", "Send multiple commands to Macarchy at once"],
    ...
    ["  run-callback", "Run Macarchy config callbacks on demand"],
    ["  split", "Split focused window"],
    ["  subscribe", "Subscribe to Macarchy events and receive notifications via socket"],
    ...
    ["  toggle-split", "Choose the split direction for the next new window"],
    ["  trigger-binding", "Trigger Macarchy binding as if it was pressed by user"],
