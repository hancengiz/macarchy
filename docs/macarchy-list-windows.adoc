= macarchy-list-windows(1)
include::util/man-attributes.adoc[]
:manname: macarchy-list-windows
// tag::purpose[]
...
[verse]
// tag::synopsis[]
macarchy list-windows [-h|--help] (--workspace <workspace>...|--monitor <monitor>...)
                       [--monitor <monitor>...] [--workspace <workspace>...]
                       [--pid <pid>] [--app-bundle-id <app-bundle-id>] [--format <output-format>]
                       [--count] [--json]
macarchy list-windows [-h|--help] --all [--format <output-format>] [--count] [--json]
macarchy list-windows [-h|--help] --focused [--format <output-format>] [--count] [--json]
...
%{window-is-fullscreen}:: Boolean. Is window in fullscreen by `macarchy fullscreen` command
