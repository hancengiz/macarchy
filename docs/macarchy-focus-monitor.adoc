= macarchy-focus-monitor(1)
include::util/man-attributes.adoc[]
:manname: macarchy-focus-monitor
// tag::purpose[]
...
[verse]
// tag::synopsis[]
macarchy focus-monitor [-h|--help] [--wrap-around] (left|down|up|right)
macarchy focus-monitor [-h|--help] [--wrap-around] (next|prev)
macarchy focus-monitor [-h|--help] [--] <monitor-pattern>...
