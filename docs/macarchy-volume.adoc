...
// end::purpose[]
:manname: macarchy-volume

// =========================================================== Synopsis
== Synopsis
[verse]
// tag::synopsis[]
macarchy volume [-h|--help] (up|down) [--no-gui]
macarchy volume [-h|--help] (mute-toggle|mute-off|mute-on) [--no-gui]
macarchy volume [-h|--help] set <number> [--no-gui]
