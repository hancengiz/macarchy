= macarchy-subscribe(1)
include::util/man-attributes.adoc[]
// tag::purpose[]
:manpurpose: Subscribe to Macarchy events and receive notifications via socket
// end::purpose[]
:manname: macarchy-subscribe

// =========================================================== Synopsis
== Synopsis
[verse]
// tag::synopsis[]
macarchy subscribe [-h|--help] [--all] [--no-send-initial] [<event>...]
...
This command connects to the Macarchy server and receives real-time event notifications as JSON lines.
