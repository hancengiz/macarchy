= macarchy-focus-back-and-forth(1)
include::util/man-attributes.adoc[]
// tag::purpose[]
:manpurpose: Switch between the current and previously focused elements back and forth
// end::purpose[]
:manname: macarchy-focus-back-and-forth

// =========================================================== Synopsis
== Synopsis
[verse]
// tag::synopsis[]
macarchy focus-back-and-forth [-h|--help]
...
Macarchy stores only one previously focused window in history,
...
----
macarchy focus-back-and-forth || macarchy workspace-back-and-forth
----
