= macarchy-list-workspaces(1)
include::util/man-attributes.adoc[]
:manname: macarchy-list-workspaces
// tag::purpose[]
...
[verse]
// tag::synopsis[]
macarchy list-workspaces [-h|--help] --monitor <monitor>... [--visible [no]] [--empty [no]] [--format <output-format>] [--count] [--json]
macarchy list-workspaces [-h|--help] --all [--format <output-format>] [--count] [--json]
macarchy list-workspaces [-h|--help] --focused [--format <output-format>] [--count] [--json]
