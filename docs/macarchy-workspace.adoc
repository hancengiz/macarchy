...
[verse]
// tag::synopsis[]
macarchy workspace [-h|--help] [--auto-back-and-forth] [--fail-if-noop] [--] <workspace-name>
macarchy workspace [-h|--help] [--wrap-around] [--stdin|--no-stdin] (next|prev)
...
`macarchy list-workspaces --monitor focused --empty no | macarchy workspace --stdin next`
