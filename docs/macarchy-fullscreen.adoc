= macarchy-fullscreen(1)
include::util/man-attributes.adoc[]
:manname: macarchy-fullscreen
// tag::purpose[]
...
[verse]
// tag::synopsis[]
macarchy fullscreen [-h|--help]     [--window-id <window-id>] [--no-outer-gaps]
macarchy fullscreen [-h|--help] on  [--window-id <window-id>] [--no-outer-gaps] [--fail-if-noop]
macarchy fullscreen [-h|--help] off [--window-id <window-id>] [--fail-if-noop]
