= macarchy-move-mouse(1)
include::./util/man-attributes.adoc[]
// tag::purpose[]
:manpurpose: Move mouse to the requested position
// end::purpose[]
:manname: macarchy-move-mouse

// =========================================================== Synopsis
== Synopsis
[verse]
// tag::synopsis[]
macarchy move-mouse [-h|--help] [--fail-if-noop] <mouse-position>
...
`macarchy move-mouse window-lazy-center || macarchy move-mouse monitor-lazy-center`
