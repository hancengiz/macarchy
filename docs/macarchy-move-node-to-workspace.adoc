= macarchy-move-node-to-workspace(1)
include::util/man-attributes.adoc[]
:manname: macarchy-move-node-to-workspace
// tag::purpose[]
...
[verse]
// tag::synopsis[]
macarchy move-node-to-workspace [-h|--help] [--focus-follows-window] [--wrap-around]
                                 [--stdin|--no-stdin]
                                 (next|prev)
macarchy move-node-to-workspace [-h|--help] [--focus-follows-window] [--fail-if-noop]
...
This flag is a shortcut for manually running `macarchy-workspace`/`macarchy-focus` after `move-node-to-workspace` successful execution.
