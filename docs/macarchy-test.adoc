...
Test if the application ID equals to Chrome: `macarchy test %{app-bundle-id} = com.google.Chrome`

Test if the application name contains "chrome" (case insensitive): `macarchy test %{app-name} ~= chrome`
