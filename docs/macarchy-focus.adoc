...
[verse]
// tag::synopsis[]
macarchy focus [-h|--help] [--ignore-floating] [--wrap-around]
...
macarchy focus [-h|--help] [--ignore-floating] [--wrap-around]
                [--boundaries <boundary>] [--boundaries-action <action>]
                (dfs-next|dfs-prev)
macarchy focus [-h|--help] --window-id <window-id>
macarchy focus [-h|--help] --dfs-index <dfs-index>
