= macarchy-macos-native-fullscreen(1)
include::util/man-attributes.adoc[]
:manname: macarchy-macos-native-fullscreen
// tag::purpose[]
...
[verse]
// tag::synopsis[]
macarchy macos-native-fullscreen [-h|--help] [--window-id <window-id>]
macarchy macos-native-fullscreen [-h|--help] [--window-id <window-id>] [--fail-if-noop] on
macarchy macos-native-fullscreen [-h|--help] [--window-id <window-id>] [--fail-if-noop] off
