...
:manname: macarchy-config
// tag::purpose[]
:manpurpose: Query Macarchy config options
// end::purpose[]
...
[verse]
// tag::synopsis[]
macarchy config [-h|--help] --get <name> [--json] [--keys]
macarchy config [-h|--help] --major-keys
macarchy config [-h|--help] --all-keys
macarchy config [-h|--help] --config-path
...
+
----
$ macarchy config --get mode.main.binding --json
{
  "alt-w" : "workspace W",
  "alt-y" : "workspace Y",
  "alt-n" : "workspace N",
