= macarchy-move-workspace-to-monitor(1)
include::util/man-attributes.adoc[]
:manname: macarchy-move-workspace-to-monitor
// tag::purpose[]
...
[verse]
// tag::synopsis[]
macarchy move-workspace-to-monitor [-h|--help] [--workspace <workspace>] [--wrap-around] (left|down|up|right)
macarchy move-workspace-to-monitor [-h|--help] [--workspace <workspace>] [--wrap-around] (next|prev)
macarchy move-workspace-to-monitor [-h|--help] [--workspace <workspace>] [--] <monitor-pattern>...
